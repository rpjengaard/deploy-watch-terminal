...
// [CHANGE: unique project identity] Related: src/config.ts, src/find.ts, src/ado.ts, src/model.ts, src/ui/app.tsx, src/cli.tsx — projectName → projectRef
  ...
  return [
    {
      ...
      pipelines: [
        {
          key: '8903da:pipeline:104', kind: 'pipeline', id: 104, name: 'DEV BE Build', projectKey: '8903da', projectRef: '8903da',
        ...
        {
          key: '8903da:pipeline:105', kind: 'pipeline', id: 105, name: 'FE Build and Deploy', projectKey: '8903da', projectRef: '8903da',
          latest: run({
        ...
        {
          key: '8903da:pipeline:120', kind: 'pipeline', id: 120, name: 'MAIN BE Build', projectKey: '8903da', projectRef: '8903da',
      ...
      releases: [
        {
          key: '8903da:release:2', kind: 'release', id: 2, name: '8903da main be deploy', projectKey: '8903da', projectRef: '8903da',
          latest: run({
    ...
    },
    {
      ...
      pipelines: [
        {
          key: '10013da:pipeline:140', kind: 'pipeline', id: 140, name: 'BE Build - Dev', projectKey: '10013da', projectRef: '10013da',
          latest: run({ id: 8, name: 'Build-20260828.7', status: 'succeeded', branch: 'develop', finished: min(55), started: min(60), queued: min(61) }),
          history: [],
        },
        {
          key: '10013da:pipeline:158', kind: 'pipeline', id: 158, name: 'BE Build - Main', projectKey: '10013da', projectRef: '10013da',
        ...
        {
          key: '10013da:pipeline:159', kind: 'pipeline', id: 159, name: 'FE Build and Deploy', projectKey: '10013da', projectRef: '10013da',
      ...
      releases: [
        {
          key: '10013da:release:1', kind: 'release', id: 1, name: '10013da dev be deploy', projectKey: '10013da', projectRef: '10013da',
        ...
        {
          key: '10013da:release:2', kind: 'release', id: 2, name: '10013da main be deploy', projectKey: '10013da', projectRef: '10013da',
